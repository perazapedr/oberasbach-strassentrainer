(function initializeCityStorage(root, factory) {
  ...
  function createCityStorage(options = {}) {
    ...
    async function saveCity(city, streets, pois, options = {}) {
      ...
      const tx = db.transaction([STORE_CITIES, STORE_STREETS, STORE_POIS], "readwrite");
      ...
      // Vorherige Straßen und POIs dieser Stadt bereinigen, um veraltete Datensätze beim Update auszuschließen
      await Promise.all([
